...
<div>
    <div class="row mb-2">
        ...
        {{-- <div class="col-6 row">
            <div class="col">
                <select wire:model="filterColumn" class="form-select form-select-sm" data-control="select2"
            ...
            <div class="col">
                <select wire:model="filterOperator" class="form-select form-select-sm" data-control="select2"
                    data-hide-search="true">
            ...
            <div class="col">
                <input type="text" wire:model.lazy="filterValue" placeholder="Value"
        ...
        <div class="col d-flex justify-content-end">
            ...
            @endif
            @if ($printable)
            <button onclick="window.print()" class="btn btn-sm btn-secondary mx-2">Print</button>
            @endif --}}
        </div>
                ...
                <tr>
                    ...
                    <th class="fw-bold bg-light">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" wire:model="selectAllCheckbox">
                        </div>
                    </th>
                    @endif
                    @foreach ($columns as $column)
                    @if ($visibleColumns[$column['key']])
                    <th class="{{ $column['class'] ?? '' }} fw-bold bg-light @if($colSort == false) block-click cursor-not-allowed @endif"
